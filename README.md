...
generated by a buldscript, enhanced with a [PHPUnit] test suite, [Composer]
ready and more.

 + Current build status:
   + branch `master`: [![Build Status](https://travis-ci.org/websafe/test-a.png?branch=master)](https://travis-ci.org/websafe/test-a/)
   + branch `develop`: [![Build Status](https://travis-ci.org/websafe/test-a.png?branch=develop)](https://travis-ci.org/websafe/test-a/)
